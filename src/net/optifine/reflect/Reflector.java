...
public class Reflector
{
    ...
    public static ReflectorMethod IForgeEffectInstance_shouldRenderInterFace = new ReflectorMethod(IForgeEffectInstance, "shouldRenderInterFace");
    public static ReflectorMethod IForgeEffectInstance_renderInterFaceEffect = IForgeEffectInstance.makeMethod("renderInterFaceEffect");
