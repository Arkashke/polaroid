...
import polaroid.client.modules.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Polaroid.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Polaroid.getInstance().getFunctionRegistry().getAutoTool();
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            boolean keepSprintState = autoSprint.isState() && autoSprint.saveSprint.get() && autoSprint.funtime.is("FunTime")
