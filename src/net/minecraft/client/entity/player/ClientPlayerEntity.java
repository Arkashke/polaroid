...
import polaroid.client.command.CommandDispatcher;
...
import polaroid.client.modules.impl.misc.AntiPush;
import polaroid.client.modules.impl.misc.SelfDestruct;
import polaroid.client.modules.impl.movement.AutoSprint;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Polaroid.getInstance().playerOnServer) {
                Polaroid.getInstance().playerOnServer = true;
            }

            Polaroid.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Polaroid.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Polaroid.getInstance().getEventBus().post(eventMotion);
        ...
        Polaroid.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Polaroid.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        Polaroid.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        Polaroid.getInstance().getEventBus().post(sprintEvent);
    ...
    NoSlowEvent noSlowEvent = new NoSlowEvent(NoSlowEvent.Type.PRE);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Polaroid.getInstance().getEventBus().post(noSlowEvent);
