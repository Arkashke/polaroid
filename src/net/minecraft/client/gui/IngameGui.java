...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        if (eventDisplay.getType() == EventDisplay.Type.PRE) {
            Polaroid.getInstance().getEventBus().post(eventDisplay);
        }
        ...
        InterFace InterFace = functionRegistry.getInterFace();
        ...
        if (!this.mc.gameSettings.hideGUI) {
            ...
            if (this.mc.playerController.shouldDrawInterFace()) {
        ...
        if (!collection.isEmpty()) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (!Reflector.IForgeEffectInstance_shouldRenderInterFace.exists()) {
                        break;
                    }

                    if (Reflector.callBoolean(effectinstance, Reflector.IForgeEffectInstance_shouldRenderInterFace)) {
                        this.mc.getTextureManager().bindTexture(ContainerScreen.INVENTORY_BACKGROUND);
                        break;
                    }
                }
                ...
                if (effectinstance.isShowIcon()) {
                    ...
                    if (Reflector.IForgeEffectInstance_renderInterFaceEffect.exists()) {
                        Reflector.call(effectinstance, Reflector.IForgeEffectInstance_renderInterFaceEffect, this,
