...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Polaroid.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Polaroid.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Polaroid.getInstance().getViaMCP().viaScreen.tick();
