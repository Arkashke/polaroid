...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public boolean renderModel(BlockState p_renderModel_1_, BlockPos p_renderModel_2_, IBlockDisplayReader p_renderModel_3_, MatrixStack p_renderModel_4_, IVertexBuilder p_renderModel_5_, boolean p_renderModel_6_, Random p_renderModel_7_, IModelData p_renderModel_8_)
    {
        try
        {
            // CustomWorld - убрать растения
            if (shouldHidePlant(p_renderModel_1_)) {
                return false;
            }
    ...
    private boolean shouldHidePlant(BlockState state) {
        try {
            ...
            if (customWorld == null || !customWorld.isState() || !customWorld.isEnabled("Убрать растения")) {
                return false;
            }
            
            // Проверяем является ли блок растением (без кувшинок, кактусов, тростника и лиан)
            net.minecraft.block.Block block = state.getBlock();
            return block instanceof net.minecraft.block.TallGrassBlock ||
                   block instanceof net.minecraft.block.FlowerBlock ||
                   block instanceof net.minecraft.block.DoublePlantBlock ||
                   block instanceof net.minecraft.block.DeadCoralWallFanBlock ||
                   block instanceof net.minecraft.block.SaplingBlock ||
                   block instanceof net.minecraft.block.MushroomBlock ||
                   block instanceof net.minecraft.block.FungusBlock ||
                   block instanceof net.minecraft.block.NetherWartBlock ||
                   block instanceof net.minecraft.block.SeaPickleBlock ||
                   block instanceof net.minecraft.block.SeaGrassBlock ||
                   block instanceof net.minecraft.block.TallSeaGrassBlock ||
                   block instanceof net.minecraft.block.KelpBlock ||
                   block instanceof net.minecraft.block.KelpTopBlock ||
                   block instanceof net.minecraft.block.CoralBlock ||
                   block instanceof net.minecraft.block.CoralPlantBlock ||
