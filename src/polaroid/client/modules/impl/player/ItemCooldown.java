...
import polaroid.client.events.EventCalculateCooldown;
...
@ModuleSystem(name = "ItemsCooldown", type = Category.Player, server = ServerCategory.NO, description = "Позволяет выставить определённую задержку на предметы")
