...
@ModuleSystem(name = "Trails", type = Category.Render, server = ServerCategory.NO, description = "Красивая полоска за игроком")
    ...
    public void onRender(WorldEvent event) {
        ...
        for (Entity entity : mc.world.getAllEntities()) {
            ...
            for (Point point : points) {
                ...
                ColorUtils.setAlphaColor(Theme.getColor(points.indexOf(point), 2), alpha * 0.5f);
