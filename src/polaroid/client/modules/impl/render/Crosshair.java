...
import static polaroid.client.utils.render.ColorUtils.IntColor.interpolate;

@ModuleSystem(name = "Crosshair", type = Category.Render, server = ServerCategory.NO, description = "Кастомный курсор")
    ...
    public void onDisplay(EventDisplay e) {
        ...
        switch (mode.getIndex()) {
            case 0 -> {
                ...
                int color = interpolate(Theme.getColor(1), Theme.getColor(1), 1 - animation);
                ...
                if (mc.gameSettings.getPointOfView() == PointOfView.FIRST_PERSON) {
                    DisplayUtils.drawOutlineCircle(x, y, 3, 2, ColorUtils.rgb(255,255,255));
                }
