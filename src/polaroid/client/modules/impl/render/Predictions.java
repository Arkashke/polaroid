...
@ModuleSystem(name = "Predictions", type = Category.Render, server = ServerCategory.NO, description = "Показывает место куда упадёт эндер-жемчуг")
        ...
        for (Entity entity : mc.world.getAllEntities()) {
            if (entity instanceof EnderPearlEntity throwable) {
                ...
                for (int i = 0; i < 150; i++) {
                    ...
                    ColorUtils.setColor(Theme.getColor(i));
