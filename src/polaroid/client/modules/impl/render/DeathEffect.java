...
@ModuleSystem(name = "KillEffect", type = Category.Render, server = ServerCategory.NO, description = "Эффект при убийстве игрока")
public class DeathEffect extends Module {
    public BooleanSetting mem = new BooleanSetting("SlenderMoment", true);
