package polaroid.client.config;
...
public class ConfigStorage {
    ...
    public final File CONFIG_DIR = new File(Minecraft.getInstance().gameDir, "\\polaroid\\configs");
    public final File AUTOCFG_FILE = new File(CONFIG_DIR, "autocfg.cfg");
    public final File LAST_USED_CONFIG_FILE = new File(CONFIG_DIR, "last_cfg.txt");
    ...
    public void setupFolder() {
        ...
        if (AUTOCFG_FILE.exists()) {
            ...
            try {
                ...
                logger.log(Level.INFO, "System configuration created!");
            } catch (IOException e) {
