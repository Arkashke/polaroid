package polaroid.client.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import polaroid.client.Polaroid;
import polaroid.client.ui.ab.render.impl.AddedItemComponent;
import polaroid.client.ui.ab.render.impl.AllItemComponent;
import polaroid.client.ui.ab.render.impl.Component;
import polaroid.client.utils.client.IMinecraft;
import polaroid.client.utils.components.ButtonComponent;
import polaroid.client.utils.components.FieldComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Polaroid.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
