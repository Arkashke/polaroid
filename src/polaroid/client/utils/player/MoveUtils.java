...
public class MoveUtils implements IMinecraft {
    ...
    /**
     * Коррекция движения с преследованием цели
     * Игрок будет двигаться в направлении цели
     */
    public static void fixMovementToTarget(final EventInput event, net.minecraft.entity.LivingEntity target, net.minecraft.util.math.vector.Vector2f rotate) {
        if (target == null) {
            return;
        }
        ...
        // Получаем ротацию к цели
        net.minecraft.util.math.vector.Vector2f targetRotation = getRotationToTarget(target.getPositionVec());
        ...
        // Применяем коррекцию движения в направлении цели
    ...
    /**
     * Вспомогательный метод для получения ротации к цели
     */
    private static net.minecraft.util.math.vector.Vector2f getRotationToTarget(net.minecraft.util.math.vector.Vector3d target) {
