package polaroid.client.utils.render.font;

public class Fonts {

    public static Font montserrat, consolas, icons,icons2, damage, sfui,sfuy, sfbold, sfMedium,tfMedium,sfsemibolt,xyinakakita,ico, excellenticon, excellentInterFace, font123, otwindowsa;
    ...
    public static void register() {
        ...
        excellenticon = new Font("clickgui.png", "clickgui.json");
        excellentInterFace = new Font("hud.png", "hud.json");
        font123 = new Font("sf_regular.png", "sf_regular.json");
        otwindowsa = new Font("tenacity.png", "tenacity.json");
